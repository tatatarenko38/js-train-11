...
function checkValueAndType(mySet, value) {
  ...
  const checkValue = mySet.has(value);
  if(checkValue === true){
...
function setToArray(mySet) {
  ...
  const arr = [...mySet];
 const arr1 = arr.filter((value) => typeof value === "string");
 arr1.sort;
 return arr1;
}
...
function sumNumbers(set) {
  ...
  //    let num = set.array.forEach(element => element + element       
  //     );
  //     return num;
  //   }
  ...
  // set.forEach((elem) => typeof elem === "number");
  // console.log(set);  
